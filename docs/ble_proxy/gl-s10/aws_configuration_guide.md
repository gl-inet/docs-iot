...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/1.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/2.png){class="glboxshadow"}

*Wifi networking*

Open the GL-S10 APP home page, find the WIFI option box, and click

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/3.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/4.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/5.png){class="glboxshadow"}

To go to the Upgrade OTA page, click on aws and then Upgrade OTA

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/6.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/7.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708113939205.png){class="glboxshadow"}

#### 4.2 Manage->Things, click Create things

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708095937397.png){class="glboxshadow"}

#### 4.3 Select Create Individual Item and click Next

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708100159600.png){class="glboxshadow"}

#### 4.4 Fill in an item name and click Next

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708100423760.png){class="glboxshadow"}

#### 4.5 Select Automatically generate a new certificate (you can use *my certificate* if you already have one) and click Next

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708100549310.png){class="glboxshadow"}

#### 4.6 Click Create policy

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708104404008.png){class="glboxshadow"}

#### 4.7 Enter a policy name, Click JSON

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708104647496.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240709175352460.png){class="glboxshadow"}

#### 4.10 Go back to the Attach policy to certificates page, check the policy you just created, and click Create thing

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708114253557.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708114443771.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708114828888.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/8.png){class="glboxshadow"}

Go to the MQTT Configuration page and click Update Certificare

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/9.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708120915001.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708161947688.png){class="glboxshadow"}

Set host and port, then click done.

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/11.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/10.png){class="glboxshadow"}

In the AWS IoT page click test -> MQTT test client -> subscribe topics -> subscribe to **GL-IoT/dataTopic/E8DB841E2B0E** this topic

![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708160828294.png){class="glboxshadow"}
...
![](https://static.gl-inet.com/docs/router/en/3/setup/gl-s10/S10_AWS_Configuration_Pic/image-20240708161137741.png){class="glboxshadow"}
